...
class Mqtt:
    def __init__(self):
        ...
        self.mqttclient.subscribe("/quantanics/industry/smallBoard", 0)  # Change the topic here
    ...
    def upload(self, msg):
        try:
            ...
            sql = "INSERT INTO `small_kit`(`humidity`, `temperature`, `distance1`, `distance2`,`ldr_val`) VALUES (%s,%s,%s,%s,%s)"
            value_sensor = (humidity, temperature, distance1, distance2, ldr_val)
