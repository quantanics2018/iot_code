...
//  Serial.println(jsonString.c_str());
  client.publish("/quantanics/industry/voltage_sensor1", jsonString.c_str());
}
...
void loop() {
  ...
  if (currentMillis - previousMillis >= interval) {
    ...
    voltage = sensorValue * (5.0 / 4095.0); // Convert analog value to voltage (assuming a 5V reference voltage and 12-bit ADC resolution)
