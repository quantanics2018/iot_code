...
class Mqtt:
    def __init__(self):
        ...
        self.mqttclient.subscribe("quantanics/industry/locker_system", 0)  # Change the topic here
    ...
    def upload(self, msg):
        try:
            ...
            smoke_value = sensor_data["smoke_value"]
            #rain_drop = sensor_data["rain_drop"]
            ...
            sql = "INSERT INTO `locker`( `distance`, `ldr`, `smoke`) VALUES (%s , %s , %s)"
            value_sensor = (distance,ldr_value,smoke_value)
