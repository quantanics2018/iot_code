...
class Mqtt:
    ...
    def upload(self, msg):
        try:
            ...
            smokeValue  = sensor_data["smokeValue"]
            ...
            sql = "INSERT INTO agri(soilmoisture, smokevalue, ph, raindrop) VALUES (%s,%s,%s,%s)"
            value_sensor = (soilMoisture,smokeValue,phValue,rain_drop)
