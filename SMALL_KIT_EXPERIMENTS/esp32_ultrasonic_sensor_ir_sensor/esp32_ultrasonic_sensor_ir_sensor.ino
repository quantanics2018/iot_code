...
const char* clientId = "db032482-2f62-4ba8-9782-da6521020735"; // MQTT client ID
...
void publishData(float distance,int ir_data){
...
//  Serial.println(jsonString.c_str());
  client.publish("quantanics/industry/ultrasonic_ir_sensor", jsonString.c_str());
}
...
void loop() {
  ...
  if (currentMillis - previousMillis >= interval) {
    ...
    int ir_Data = digitalRead(IR_SENSOR_PIN);  
